...
| `API_SECRET_KEY` | **推荐**：API 密钥，用于接口鉴权 | `123456` |
...
本项目采用 **GNU General Public License v3.0** 开源协议。详情请参阅 [LICENSE](LICENSE) 文件或访问：[https://www.gnu.org/licenses/gpl-3.0.html](https://www.gnu.org/licenses/gpl-3.0.html)
